...
public class QSpecializationService : IQSpecializationService
{
    ...
    {
        Specialization specializationSource = new(qSpecializationParameters.label, qSpecializationParameters.Name, qSpecializationParameters.Description, qSpecializationParameters.RoleInformation, qSpecializationParameters.IndexName, qSpecializationParameters.ImageFilePath!, qSpecializationParameters.IconFilePath, qSpecializationParameters.GroupMemberships);
